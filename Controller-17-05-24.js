...
const { GenerateRandomName,TimeFormater,DOBFormat, ExcelDataEXtraction} = require("./CustomFunction");
...
//==============READ EXCEL DATA ==========================
const ExcelData = ExcelDataEXtraction(req?.files?.excelfile[0]?.path,Policy_no);
...
let table = '';
  ...
  table += `<table>==============================================================
   ...
   ==============================================================`;
   table += `<table>
   <tr><td style="font-weight:bold">Co-Payment</td> <td>&nbsp : &nbsp;</td><td>${(ExcelData[0]?.CoPayment !==undefined) ? ExcelData[0]?.CoPayment: 'NA' }</td></tr> 
   <tr><td style="font-weight:bold">Co-Insurance</td> <td>&nbsp : &nbsp;</td> <td>${(ExcelData[0]?.CoInsurance !==undefined) ? ExcelData[0]?.CoInsurance:'NA'}</td></tr> 
   <tr><td style="font-weight:bold">Deductible Individual</td> <td>&nbsp : &nbsp;</td><td>${(ExcelData[0]?.DeductibleIndividual !==undefined) ? ExcelData[0]?.DeductibleIndividual:'NA'}</td></tr> 
   <tr><td style="font-weight:bold">Deductible Individual Met</td> <td>&nbsp : &nbsp;</td><td>${(ExcelData[0]?.DeductibleIndividualMet !==undefined) ? ExcelData[0]?.DeductibleIndividualMet:'NA'}</td></tr>
   <tr><td style="font-weight:bold">Deductible Individual Remaining</td> <td>&nbsp : &nbsp;</td><td>${(ExcelData[0]?.DeductibleIndividualRemaining !==undefined) ? ExcelData[0]?.DeductibleIndividualRemaining :'NA'}</td></tr> 
   <tr><td style="font-weight:bold">Deductible Family</td> <td>&nbsp : &nbsp;</td> <td>${(ExcelData[0]?.DeductibleFamily !==undefined) ? ExcelData[0]?.DeductibleFamily:'NA'}</td></tr> 
   <tr><td style="font-weight:bold">Deductible Family Met</td> <td>&nbsp : &nbsp;</td> <td>${(ExcelData[0]?.DeductibleFamilyMet !==undefined) ? ExcelData[0]?.DeductibleFamilyMet :'NA'}</td></tr> 
   <tr><td style="font-weight:bold">Deductible Family Remaining</td> <td>&nbsp : &nbsp;</td> <td>${(ExcelData[0]?.DeductibleFamilyRemaining !==undefined) ? ExcelData[0]?.DeductibleFamilyRemaining:'NA'}</td></tr> 
   <tr><td style="font-weight:bold">Out Of Pocket Individual</td> <td>&nbsp : &nbsp;</td> <td>${(ExcelData[0]?.OutOfPocketIndividual !==undefined) ? ExcelData[0]?.OutOfPocketIndividual:'NA'}</td></tr>
   <tr><td style="font-weight:bold">Out Of Pocket Individual Met</td> <td>&nbsp : &nbsp;</td> <td>${(ExcelData[0]?.OutOfPocketIndividualMet !==undefined) ? ExcelData[0]?.OutOfPocketIndividualMet:'NA'}</td></tr>
   <tr><td style="font-weight:bold">Out Of Pocket Individual Remaining</td> <td>&nbsp : &nbsp;</td> <td>${(ExcelData[0]?.OutOfPocketIndividualRemaining !==undefined) ? ExcelData[0]?.OutOfPocketIndividualRemaining:'NA'}</td></tr> 
   <tr><td style="font-weight:bold">Out Of Pocket Family</td> <td>&nbsp : &nbsp;</td> <td>${(ExcelData[0]?.OutOfPocketFamily !==undefined) ? ExcelData[0]?.OutOfPocketFamily:'NA'}</td></tr> 
   <tr><td style="font-weight:bold">Out Of Pocket Family Met</td> <td>&nbsp : &nbsp;</td> <td>${(ExcelData[0]?.OutOfPocketFamilyMet !==undefined) ? ExcelData[0]?.OutOfPocketFamilyMet:'NA'}</td></tr>
   <tr><td style="font-weight:bold">Out Of Pocket Family Remaining</td> <td>&nbsp : &nbsp;</td> <td>${(ExcelData[0]?.OutOfPocketFamilyRemaining !==undefined) ? ExcelData[0]?.OutOfPocketFamilyRemaining: 'NA'}</td></tr>
   `;
        ...
        if (CData !== undefined) {
          ...
          Object.entries(CData)?.map((childVal, index) => {
            ...
            if (
              ...
              childVal[0] == "amount")  || (val[0] == "amount_coPayment_inNetwork" &&
              childVal[0] == "total")
            ) {
              table += `<tr>
            ...
            //  condition for amount_outOfPocket_inNetwork
              ...
              childVal[0] == "amount") || (val[0] == "amount_outOfPocket_inNetwork" &&
              childVal[0] == "total")
               ) {
              table += `<tr><td>${childVal[0]}</td> <td>&nbsp : &nbsp;</td> <td>$${childVal[1]}</td></tr>`;
            }
            ...
            //  condition for amount_deductibles_inNetwork
              ...
              childVal[0] == "amount") || (val[0] == "amount_deductibles_inNetwork" &&
              childVal[0] == "total")
            ) {
              table += `<tr><td>${childVal[0]}</td> <td>&nbsp : &nbsp;</td> <td>$${childVal[1]}</td></tr>`;
            }
...
let fullFilePath = "public/output/"+Policy_no+"_"+fileName+".html" ;
