...
<tr><td style="font-weight:bold" >Payer</td> <td>&nbsp : &nbsp;</td> <td>${JsonData?.payer?.name}</td></tr>
 ...
 <tr><td style="font-weight:bold">Group Name</td> <td>&nbsp : &nbsp;</td> <td>${
  JsonData?.plans[0]?.groupName !== undefined
    ? JsonData?.plans[0]?.groupName
    : ""
}</td></tr>
 ...
 `;
     //  Requesting Provider Detail
    table += `<table>==============================================================`;
  table += `<h3 style="font-weight:bold; padding-top:0px;" >Requesting Provider</h3>`;
  table += `<table>==============================================================`;

table += `<table>
<tr><td style="font-weight:bold">Name</td> <td>&nbsp : &nbsp;</td> <td>${Requesting_provider_name}</td></tr> 
<tr><td style="font-weight:bold">Category</td> <td>&nbsp : &nbsp;</td> <td> ${(JsonData?.requestingProvider?.category !==undefined) ? JsonData?.requestingProvider?.category:'NA'}</td></tr> 
<tr><td style="font-weight:bold">Type</td> <td>&nbsp : &nbsp;</td> <td>${(JsonData?.requestingProvider?.type !==undefined) ? JsonData?.requestingProvider?.type:''}</td></tr> 
<tr><td style="font-weight:bold">Role</td> <td>&nbsp : &nbsp;</td> <td>${(JsonData?.requestingProvider?.role !==undefined) ? JsonData?.requestingProvider?.role:''}</td></tr> 
<tr><td style="font-weight:bold">NPI</td> <td>&nbsp : &nbsp;</td> <td>${(JsonData?.requestingProvider?.npi !==undefined) ? JsonData?.requestingProvider?.npi:''}</td></tr>
<tr><td style="font-weight:bold">Place Of Service</td> <td>&nbsp : &nbsp;</td> <td>${(JsonData?.requestingProvider?.placeOfService !==undefined) ? JsonData?.requestingProvider?.placeOfService:''}</td></tr> 
<tr><td style="font-weight:bold">Address</td> <td>&nbsp : &nbsp;</td>
 ${(JsonData?.requestingProvider?.address !==undefined) ? `<td>${JsonData?.requestingProvider?.address?.line1}</br>${JsonData?.requestingProvider?.address?.line2}</br>${JsonData?.requestingProvider?.address?.city} ${JsonData?.requestingProvider?.address?.stateCode} ${JsonData?.requestingProvider?.address?.zipCode}</td>`
         :'<td>NA</td>'} </tr> 
          `;
